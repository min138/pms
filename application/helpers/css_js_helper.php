...
if (!function_exists('description_limit')) {

    function description_limit($str, $limit = 100, $strip = false) {
...
/* End of file css_js_helper.php */
/* Location: ./application/helpers/css_js_helper.php */
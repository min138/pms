...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title><?php echo $title; ?> | PMS</title>
        ...
        <link href="<?php echo asset_url('plugins/simple-line-icons/simple-line-icons.min.css'); ?>" rel="stylesheet" type="text/css"/>
        ...
        <!-- BEGIN THEME STYLES -->
        <?php echo add_css('style-conquer.css'); ?>
        <?php echo add_css('style.css'); ?>
        <?php echo add_css('style-responsive.css'); ?>
        <?php echo add_css('plugins.css'); ?>
        <?php echo add_css('themes/default.css'); ?>
        <?php echo add_css('pages/login.css'); ?>
    ...
    <body class="login">
        ...
        <div class="content">
            ...
            <form class="login-form" action="<?php echo base_url() . 'auth'; ?>" method="post">
                ...
                <h3 class="form-title">Login to PMS</h3>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="text" value="<?php echo set_value('username'); ?>"  autocomplete="off" placeholder="Username" name="username" id="username"/>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="password" value="<?php echo set_value('password'); ?>" autocomplete="off" placeholder="Password" name="password" id="password"/>
        ...
        <script src="<?php echo asset_url('scripts/login.js'); ?>" type="text/javascript"></script>
        <!-- END PAGE LEVEL SCRIPTS -->
        <script>

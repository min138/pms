...
<div class="portlet ">
    ...
    <div class="portlet-body form">
        <form class="form-horizontal" action="<?php echo base_url() . 'holiday_master/update_holiday/' . $holiday_id; ?>"role="form" method="post"> 
                ...
                foreach ($record_edit as $row) {
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control"  name="holiday_name" value="<?php echo $row->holiday_name; ?>" placeholder="Enter text">
        ...
        <!--                        <span class="help-block">
            A block of help text. </span>-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="holiday_description"  rows="3"><?php echo $row->holiday_description; ?></textarea>
                    ...
                    <div class="form-group" id="vacation" style="display: none">
                        ...
                        <div class="col-md-4">
                            <div class="input-group input-large">
                                <input type="text" class="form-control date-picker" name="date_from" value="<?php echo $row->date_from; ?>" >
                                <?php echo form_error('date_from'); ?>
                                <span class="input-group-addon">
                                    to </span>
                                <input type="text" class="form-control date-picker" name="date_to" value="<?php echo $row->date_to; ?>">
